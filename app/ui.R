...
shinyUI(basicPage(
  ...
  div(class="map-wrapper",
    leafletMap(
      "map", "100%", "100%",
      initialTileLayer = 'GOOGLE', # TODO change from google to ESRI
    ...
    bsTooltip("downloadBtn", "Download data to computer.", placement = "bottom",
              trigger = "hover"),
    bsTooltip("emailBtn", "Email data to friend.", placement = "bottom",
              trigger = "hover")
  ),
